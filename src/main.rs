...
fn run_eigensnp_rust_workflow(cli_args: &CliArgs) -> Result<(), Error> {
    ...
    const MAX_HEURISTIC_IO_ACTORS: usize = 16;
    let absolute_max_io_actors_for_ioservice = (actual_num_compute_threads / 2)
    ...
    let prep_config = MicroarrayDataPreparerConfig {
        ...
        min_snp_call_rate_threshold: cli_args.eigensnp_min_call_rate.unwrap_or(1.0),
