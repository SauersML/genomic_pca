...
def generate_run_configs():
    ...
    sweeps = {
        "eigensnp_min_maf": [0.005, 0.01, 0.05],
        "eigensnp_max_hwe_p": [1e-7, 1.0], # 1.0 disables HWE
        "eigensnp_components_per_block": [3, 7, 10, 15],
        "eigensnp_subset_factor": [0.05, 0.075, 0.15],
        "eigensnp_min_subset_size": [5000, 10000, 20000],
        "eigensnp_max_subset_size": [30000, 40000, 60000],
        "eigensnp_global_oversampling": [5, 10, 15],
        "eigensnp_global_power_iter": [0, 2, 4],
        "eigensnp_local_oversampling": [5, 10, 15],
        "eigensnp_local_power_iter": [0, 2, 4],
        "eigensnp_snp_strip_size": [1000, 2000, 5000],
        "eigensnp_refine_passes": [0, 1, 2, 3, 5, 10, 15, 20],
    }
